...
const Journey = () =>{
    return(
        <section className="mt-32 mb-20 gap-4 md:mx-40 mx-4">
            <div className="min-w-full flex flex-col justify-center items-center ">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-10 mt-14 min-w-full ">
                    ...
                    <InforPlan icon="map" title="Expert Local Insights" name="Insider Tips and Recommendations" name="" decs="We provide curated recommendations for dining, sightseeing, and hidden gems, so you can experience each destination like a local."/>
                </div>
            </div>
        </section>
    );
